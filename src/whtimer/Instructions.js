  ...
  return (
    <Modal show={showModal} onHide={() => closeModal()}>
      <Modal.Header
        ...
        closeButton
      >
        <Modal.Title>Wim Hoff Breathing Method</Modal.Title>
      </Modal.Header>
      <Modal.Body
        style={{
          background: 'linear-gradient(60deg, #29323c 0%, #485563 100%)',
          color: ' rgb(238, 236, 236, 0.9)',
        }}
      >
        <ul style={{ listStyle: 'none' }}>
          <li>
            ...
            <span>
              sitting, lying down — whichever is most comfortable for you. Make
              sure you can expand your lungs freely without feeling any
              constriction.
            </span>
          </li>
          <li>
          ...
          <li>
            ...
            <span>
              inhale one final time, as deeply as you can. Then let the air out
              and stop breathing. Hold until you feel the urge to breathe again.
            </span>
          </li>
          <li>
            ...
            <span>
              ...
              fill your lungs. Feel your belly and chest expanding. When you are
              at full capacity, hold the breath for around 15 seconds, then let
              go. That completes round number one. This cycle can be repeated
              3-4 times without interval. After having completed the breathing
              exercise, take your time to bask in the bliss. This calm state is
              highly conducive to meditation — don't hesitate to combine the
              two.
            </span>
          </li>
        </ul>
